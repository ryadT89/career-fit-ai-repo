...
import { HiClipboardList, HiDocumentDuplicate, HiDocumentSearch, HiInbox } from 'react-icons/hi';
            ...
            <div className="flex justify-between flex-col h-full p-4 bg-base-content shadow-md rounded-r-3xl text-white">
                ...
                <div className='flex flex-col gap-2'>
                    <div className='btn text-white bg-sky-400 w-full border-none rounded-2xl' onClick={showModal}>
                        <HiDocumentSearch className='text-xl' /><span className='hidden lg:inline'>My Resume</span>
                        <MyResume modalRef={modalRef} />
                    </div>
