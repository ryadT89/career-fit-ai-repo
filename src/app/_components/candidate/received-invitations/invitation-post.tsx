...
export function InvitationPost({ profilePicture, recruiterName, message, time}: { profilePicture: string, recruiterName: string, message: string, time: Date }) {
    ...
    return (
        <div className="shadow-lg rounded-xl p-4 cursor-pointer hover:bg-gray-50">
            <div className='flex gap-1 items-center'>
                <ProfilePicture className='w-6 h-6' src={profilePicture || ''} />
