...
export function ApplicationPost({ title, description, applicationStatus, user, time }: { title: string, description: string, applicationStatus: string, user: string, time: Date}) {
